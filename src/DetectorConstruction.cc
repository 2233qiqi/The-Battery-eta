...
G4VPhysicalVolume *DetectorConstruction::Construct()
{
    ...
    G4VisAttributes *sicVisAtt = new G4VisAttributes(G4Colour(0.0, 0.0, 0.0, 0.3));
 ...
 */
    ...
    G4double Ni63X = 10 * um, Ni63Y = 10 * um, Ni63Z = 0.5 * um;
    ...
    G4VPhysicalVolume *physNi63 = new G4PVPlacement(0, G4ThreeVector(0., 0., -0.5 * um), logicalNi63, "PhysNi63", logicWorld, false, 0, checkOverlaps);
